...
class MainWindow:
    ...
    def __init__(self):
        ...
        lbl_title = tk.Label(text='SPAN', font=('Helvetika', 16, 'bold'),
                              fg='#0000cc', justify='center')
        lbl_title.place(x=25, y=15, width=250, height=50)

        # Добавление метки заголовка данных
        lblTitle1 = tk.Label(text='Данные', font=('Helvetika', 12, 'bold'),
        ...
        btn_report = tk.Button(self.window, text='Отделы',
                              font=('Helvetika', 10, 'bold'), bg='#ccffcc')
