...
class EmployeesWindow:
    ...
    def __init__(self):
        ...
        lbl_title = tk.Label(self.window, text='Сотрудники', font=('Helvetica', 16, 'bold'),
                             fg='#0000cc', justify='center')
        ...
        self.btn_add = tk.Button(self.window, text='Добавить',
                              ...
                              bg='#ccffff', command=self.add_record)
    ...
    def refresh_listbox(self, selection: int, values: str):
        self.lbox_data_rows.delete(selection, selection)
        self.lbox_data_rows.insert(selection, values)
